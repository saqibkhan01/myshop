...
const Homescreen = ({user, navigation}) => {
        ...
        <View style={styles.container1}>
          ...
          <View style={styles.container2}>
            ...
            <View style={styles.addview}>
              ...
              <Text style={[styles.addtext, styles.margin]}>{counter}</Text>
              <TouchableOpacity style={styles.add} onPress={() => selectdata(item.id)}>
                <Text style={styles.addtext}>+</Text>
              </TouchableOpacity>
            </View>
            ...
            <TouchableOpacity style={styles.submit} onPress={() => addnew(item.id)}>
  ...
  const addnew = id => {
    const newData = [...masterDataSource];
const array =[...newdata];
    newData.filter((x)  =>
    {
      if(x.id === id){
    ...
    <View style={styles.container}>
        ...
        <View style={styles.container4}>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("edit")}>
            <View>
            <Text style={{fontSize: 20, fontWeight: 'bold', color: 'blue'}}>{profile.name}</Text>
            </View>
          </TouchableOpacity>
          <TouchableOpacity onPress={() => navigation.navigate("order",{newdata})}>
          <View>
            <Image style={{height:25,width:25}} source={{uri: "https://cdn-icons-png.flaticon.com/512/709/709640.png"}}/>
          </View>
          </TouchableOpacity>
        </View>
